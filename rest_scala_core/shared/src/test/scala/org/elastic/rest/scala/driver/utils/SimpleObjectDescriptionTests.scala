...
import org.elastic.rest.scala.driver.RestBase.ToStringAnyVal
...
object SimpleObjectDescriptionTests extends TestSuite {
  val tests = this {
    "Basic mock functionality - handled" - {
      ...
      case class Test
        (field1: Either[String, Boolean], `termName`: ValueClassTest, termValue: List[Int], valOrVals: List[String],
      ...
      val test1 = Test(
        field1 = Left("test"), `termName` = ValueClassTest("myTermName"), termValue = List(1, 2, 3), valOrVals = List(),
      ...
      /** Tests an unpleasant case where the macro/runtime logic breaks down */
      case class Test3(o1: Option[String], o2: Option[String], o3: Option[String], o4: Option[String])
        extends CustomTypedToString
      {
        @SimpleObjectDescription("",
          Field("o1"), Field("o2"), Field("o3"), Field("o4")
        )
        override def fromTyped: String = AutoGenerated
      }
      val test3_1 = Test3(None, Some("b"), Some("c"), None)
      parse(test3_1.fromTyped) ==> parse("""{"o2": "b", "o3":"c"}""")

      /** This case is similar to `Test3` ... except the underlying logic works OK so
        * it's just here for illustration
        */
      case class Test4(key: String, value: String,
                       o1: Option[String], o2: Option[String], o3: Option[String], o4: Option[String])
        extends CustomTypedToString
      {
        @SimpleObjectDescription("",
          KeyValue("key")("value", Field("o1"), Field("o2"), Field("o3"), Field("o4"))
        )
        override def fromTyped: String = AutoGenerated
      }
      val test4_1 = Test4("mykey", "myval", None, Some("b"), Some("c"), None)

      parse(test4_1.fromTyped) ==> parse(
        """{ "mykey":
          |{"value": "myval", "o2": "b", "o3":"c"} }
          |""".stripMargin)
